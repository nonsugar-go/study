...
3. 仮想マシンの電源を入れて、インストーラーを起動
   ...
   5. 再起動後、root でログイン
      ...
      apk update
      apk add --no-cache xorg-server xf86-video-vesa xf86-input-libinput xf86-input-vmmouse xf86-input-keyboard \
        xinit xterm open-vm-tools openbox tint2 firefox-esr dbus udev
