...
5. 同様に全てのインタフェースの設定をする
   ...
   |------|-------------------|------------------|------------------|------------------|-----------|--------------------|--------------------|
   | eth0 | This network      | 192.168.1.41/24  | 192.168.1.42/24  | 192.168.1.43/24  | Mgmt      | InternalZone       | ブロックしてログ記録 |
...
8. 同様に全てのインタフェースの設定をする
   ...
   |------|-------------------|------------------|-----------|--------------------|--------------------|
   | eth0 | This network      | 192.168.1.44/24  | Mgmt      | InternalZone       | ブロックしてログ記録 |
