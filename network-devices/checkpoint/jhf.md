...
3. Gaia Portal > Software Updates > Available Updates > + Add Package ▼ > From your computer: `Check_Point_R82_10_jumbo_hf    _main_Bundle_T6_FULL.tar` を選択して、`[Import]` をクリック
