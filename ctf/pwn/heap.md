...
```
 | 0x20(32) - 0x80(128) | 0x90(144) - 0x3f0(1008) | 0x400(1024) | 0x410(1040) | 0x420(1056) - |
-+----------------------+-------------------------+-------------+-------------+---------------+-
 |<-------------------------------- tcache ---------------------------------->|               |
 |<------ fastbin ----->|                         |             |             |               |
 |<----------------------------------------- unsortedbin ------------------------------------>|
...
```
 chunk_a +->[................][size____________]
         |  [__free_hook-0x18][shellcode_addr__]
         |  [SHELL_CODE______][SHELL_CODE______]
         ...
         |  [________________][________________]
         |  [________________][________________]
 chunk_b +--[prev_size(0x90)_][size(0x90)_____0]---o Clear PREV_INUSE bit
            [________________][________________]
            [________________][________________] P = fake chunk (chunk_a)
            [________________][________________] unlink(P)
            [________________][________________]    ↓
            [________________][________________] P->fd->bk = P->bk
            [________________][________________] P->bk->fd = P->fd
            [________________][________________]
            [________________][________________]
            [________________][................]
```
